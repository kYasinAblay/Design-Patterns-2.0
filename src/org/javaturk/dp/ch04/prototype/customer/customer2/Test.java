package org.javaturk.dp.ch04.prototype.customer.customer2;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		IndividualCustomer ic2 = (IndividualCustomer) prototype.cloneAuthenticatedAndValidatedIndividualCustomer();
		ic2.setId(4);
		...
		ic2.setPhone("phone4");
		ic2.setDob(new Date());
		// No need for next two lines anymore.
